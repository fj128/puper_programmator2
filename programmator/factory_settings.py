...
;            AA   AA  TY  PN   HH      MM   KK  KK   PP   UU   U0
        DB   99h, 99h, 0, 00, 0Eh,   10H,  16h,02h, 00h, 00h, 00h, FFH
...
;
  ...
  ORG 624   ;
    ...
    ORG 630
    DB      FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH  ;0
    ORG 650
    DB      FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH  ;0
    ORG 670
    DB      FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH, FFH,FFH,FFH,FFH  ;0
   ...
   ;SYSTEM ARRAY
;    1010, 1011 - Version
;    1012, 1013 - Data    EPROM Control sum 0 .. 1011
;    1014 .. 1016  6 digit PIN code
;    1017 SIGNATURA 0xAA - bilo progr, trebuetsja CLS; 0x55 - work
;    1021, ZONE_Is
